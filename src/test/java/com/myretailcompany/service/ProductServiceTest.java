...
public class ProductServiceTest {
	...
	public void testProductCreate(){
		Product p1 = productService.createProduct(new ProductInfo("EBC-abc-0001", 20.0, "Tomato", ProductCategory.GROCERIES));
	...
	public void testProductUpdate(){
		Product p1 = productService.createProduct(new ProductInfo("FBC-abc-0001", 20.0, "Tomato", ProductCategory.GROCERIES));
		Product p2 = productService.updateProduct(new ProductInfo("FBC-abc-0002", 30.0, "Potato", ProductCategory.GROCERIES),p1.getId());
	...
	public void testProductUpdateForNonExistingProduct(){
		productService.createProduct(new ProductInfo("GBC-abc-0001", 20.0, "Tomato", ProductCategory.GROCERIES));
		productService.updateProduct(new ProductInfo("GBC-abc-0002", 30.0, "Potato", ProductCategory.GROCERIES),(long)99999); 
	}
	
	
	@Test(expected=CustomException.class)
	public void testProductDelete(){
		Product p1 = productService.createProduct(new ProductInfo("HBC-abc-0001", 20.0, "Tomato", ProductCategory.GROCERIES));
